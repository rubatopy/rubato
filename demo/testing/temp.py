...
fontfile = os.path.join(os.path.dirname(os.path.abspath(__file__)), "fonts", "32bit Regular.ttf").encode("utf-8")
...
class TestSDLTTF(object):
    ...
    def test_TTF_FontFaceFamilyName(self):
        font = sdlttf.TTF_OpenFont(fontfile, 10)
        assert sdlttf.TTF_FontFaceFamilyName(font) == b"32bit Regular.ttf"
        sdlttf.TTF_CloseFont(font)
