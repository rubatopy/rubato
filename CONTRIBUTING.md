...
## First things
As a new contributor you will need to fork the repository to implement your changes. Please look at our [issues](https://github.com/rubatopy/rubato/issues) for something to start off with. Once you are happy with your changes open up a pull request and our devs will review and give comments before a merge occurs. After having contributed to the project you will be put on the CONTRIBUTORS.md document. Thank you for your help!
