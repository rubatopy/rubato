...
* We recommend using [Visual Studio Code](https://code.visualstudio.com/) and installing all of our extensions, this will commit your code with the correct formatting and type checking.
