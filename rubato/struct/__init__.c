...
{
    "distutils": {
        "name": "rubato.struct.__init__",
        "sources": [
            "rubato/struct/__init__.py"
        ]
    },
    "module_name": "rubato.struct.__init__"
}
END: Cython Metadata */
...
#define __PYX_HAVE__rubato__struct____init__
#define __PYX_HAVE_API__rubato__struct____init__
/* Early includes */
#ifdef _OPENMP
#include <omp.h>
#endif /* _OPENMP */
...
/* Module declarations from "rubato.struct.__init__" */
#if !CYTHON_USE_MODULE_STATE
#endif
/* #### Code section: typeinfo ### */
/* #### Code section: before_global_var ### */
#define __Pyx_MODULE_NAME "rubato.struct.__init__"
extern int __pyx_module_is_main_rubato__struct____init__;
int __pyx_module_is_main_rubato__struct____init__ = 0;

/* Implementation of "rubato.struct.__init__" */
...
static __Pyx_StringTabEntry __pyx_string_tab[] = {
  ...
  {0, __pyx_k_scene, sizeof(__pyx_k_scene), 0, 0, 1, 1},
  {0, __pyx_k_sprite, sizeof(__pyx_k_sprite), 0, 0, 1, 1},
  {0, __pyx_k_struct, sizeof(__pyx_k_struct), 0, 1, 0, 1},
...
static CYTHON_SMALL_CODE int __Pyx_InitConstants(void) {
  ...
  if (__Pyx_InitString(__pyx_string_tab[1], &__pyx_n_s_Group) < 0) __PYX_ERR(0, 1, __pyx_L1_error);
  if (__Pyx_InitString(__pyx_string_tab[2], &__pyx_n_s_Scene) < 0) __PYX_ERR(0, 1, __pyx_L1_error);
  if (__Pyx_InitString(__pyx_string_tab[3], &__pyx_n_s_Sprite) < 0) __PYX_ERR(0, 1, __pyx_L1_error);
  ...
  if (__Pyx_InitString(__pyx_string_tab[7], &__pyx_n_s_gameobject) < 0) __PYX_ERR(0, 1, __pyx_L1_error);
  ...
  if (__Pyx_InitString(__pyx_string_tab[12], &__pyx_n_s_scene) < 0) __PYX_ERR(0, 1, __pyx_L1_error);
  if (__Pyx_InitString(__pyx_string_tab[13], &__pyx_n_s_sprite) < 0) __PYX_ERR(0, 1, __pyx_L1_error);
  if (__Pyx_InitString(__pyx_string_tab[14], &__pyx_n_u_struct) < 0) __PYX_ERR(0, 1, __pyx_L1_error);
...
namespace {
  ...
  #endif
  {
      ...
      "struct",
      __pyx_k_The_classes_module_holds_all_of, /* m_doc */
    #if CYTHON_PEP489_MULTI_PHASE_INIT
      0, /* m_size */
...
__Pyx_PyMODINIT_FUNC init__init__(void) { initstruct(); }
#endif
__Pyx_PyMODINIT_FUNC initstruct(void)
#else
__Pyx_PyMODINIT_FUNC PyInit_struct(void) CYTHON_SMALL_CODE; /*proto*/
#if !defined(CYTHON_NO_PYINIT_EXPORT) && (defined(_WIN32) || defined(WIN32) || defined(MS_WINDOWS))
__Pyx_PyMODINIT_FUNC PyInit___init__(void) { return PyInit_struct(); }
#endif
...
#endif
{
  ...
  #else
  #if PY_MAJOR_VERSION < 3
  __pyx_m = Py_InitModule4("struct", __pyx_methods, __pyx_k_The_classes_module_holds_all_of, 0, PYTHON_API_VERSION); Py_XINCREF(__pyx_m);
...
if (!__Pyx_RefNanny) {
  ...
  #endif
  if (__pyx_module_is_main_rubato__struct____init__) {
    if (PyObject_SetAttr(__pyx_m, __pyx_n_s_name, __pyx_n_s_main) < 0) __PYX_ERR(0, 1, __pyx_L1_error)
  }
  if (!CYTHON_PEP489_MULTI_PHASE_INIT) {
    if (unlikely((__Pyx_SetPackagePathFromImportLib("rubato", __pyx_n_u_struct) < 0))) __PYX_ERR(0, 1, __pyx_L1_error)
  }
  #if PY_MAJOR_VERSION >= 3
  {
    PyObject *modules = PyImport_GetModuleDict(); if (unlikely(!modules)) __PYX_ERR(0, 1, __pyx_L1_error)
    if (!PyDict_GetItemString(modules, "rubato.struct")) {
      if (unlikely((PyDict_SetItemString(modules, "rubato.struct", __pyx_m) < 0))) __PYX_ERR(0, 1, __pyx_L1_error)
    }
  }
  #endif
  /*--- Builtin init code ---*/
 ...
 */
  ...
  __pyx_t_3 = __Pyx_Import(__pyx_n_s_sprite, __pyx_t_2, 1); if (unlikely(!__pyx_t_3)) __PYX_ERR(0, 4, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_3);
  __Pyx_DECREF(__pyx_t_2); __pyx_t_2 = 0;
  __pyx_t_2 = __Pyx_ImportFrom(__pyx_t_3, __pyx_n_s_Sprite); if (unlikely(!__pyx_t_2)) __PYX_ERR(0, 4, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_2);
  if (PyDict_SetItem(__pyx_d, __pyx_n_s_Sprite, __pyx_t_2) < 0) __PYX_ERR(0, 4, __pyx_L1_error)
  __Pyx_DECREF(__pyx_t_2); __pyx_t_2 = 0;
  __Pyx_DECREF(__pyx_t_3); __pyx_t_3 = 0;

  /* "rubato/struct/__init__.py":5
 * """
 * from .sprite import Sprite
 * from .gameobject import *             # <<<<<<<<<<<<<<
 * from .group import Group
 ...
 */
  ...
  __pyx_t_2 = __Pyx_Import(__pyx_n_s_gameobject, __pyx_t_3, 1); if (unlikely(!__pyx_t_2)) __PYX_ERR(0, 5, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_2);
  __Pyx_DECREF(__pyx_t_3); __pyx_t_3 = 0;
  if (__pyx_import_star(__pyx_t_2) < 0) __PYX_ERR(0, 5, __pyx_L1_error);
  __Pyx_DECREF(__pyx_t_2); __pyx_t_2 = 0;

  /* "rubato/struct/__init__.py":6
 * from .sprite import Sprite
 * from .gameobject import *
 * from .group import Group             # <<<<<<<<<<<<<<
 * from .scene import Scene
 */
  ...
  __pyx_t_3 = __Pyx_Import(__pyx_n_s_group, __pyx_t_2, 1); if (unlikely(!__pyx_t_3)) __PYX_ERR(0, 6, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_3);
  __Pyx_DECREF(__pyx_t_2); __pyx_t_2 = 0;
  __pyx_t_2 = __Pyx_ImportFrom(__pyx_t_3, __pyx_n_s_Group); if (unlikely(!__pyx_t_2)) __PYX_ERR(0, 6, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_2);
  if (PyDict_SetItem(__pyx_d, __pyx_n_s_Group, __pyx_t_2) < 0) __PYX_ERR(0, 6, __pyx_L1_error)
  __Pyx_DECREF(__pyx_t_2); __pyx_t_2 = 0;
  __Pyx_DECREF(__pyx_t_3); __pyx_t_3 = 0;

  /* "rubato/struct/__init__.py":7
 * from .gameobject import *
 * from .group import Group
 * from .scene import Scene             # <<<<<<<<<<<<<<
 */
  ...
  PyList_SET_ITEM(__pyx_t_3, 0, __pyx_n_s_Scene);
  __pyx_t_2 = __Pyx_Import(__pyx_n_s_scene, __pyx_t_3, 1); if (unlikely(!__pyx_t_2)) __PYX_ERR(0, 7, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_2);
  __Pyx_DECREF(__pyx_t_3); __pyx_t_3 = 0;
  __pyx_t_3 = __Pyx_ImportFrom(__pyx_t_2, __pyx_n_s_Scene); if (unlikely(!__pyx_t_3)) __PYX_ERR(0, 7, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_3);
  if (PyDict_SetItem(__pyx_d, __pyx_n_s_Scene, __pyx_t_3) < 0) __PYX_ERR(0, 7, __pyx_L1_error)
  __Pyx_DECREF(__pyx_t_3); __pyx_t_3 = 0;
  __Pyx_DECREF(__pyx_t_2); __pyx_t_2 = 0;

  /* "rubato/struct/__init__.py":1
 * """             # <<<<<<<<<<<<<<
 * The classes module holds all of the high-dependency modules relating to game objects.
 * """
 */
  ...
  if (__pyx_m) {
    if (__pyx_d && stringtab_initialized) {
      __Pyx_AddTraceback("init rubato.struct.__init__", __pyx_clineno, __pyx_lineno, __pyx_filename);
    }
    #if !CYTHON_USE_MODULE_STATE
    Py_CLEAR(__pyx_m);
    #endif
  } else if (!PyErr_Occurred()) {
    PyErr_SetString(PyExc_ImportError, "init rubato.struct.__init__");
  }
  __pyx_L0:;
  __Pyx_RefNannyFinishContext();
  #if CYTHON_PEP489_MULTI_PHASE_INIT
