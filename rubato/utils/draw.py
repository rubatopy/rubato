...
class Draw:
    ...
    def line(p1: VectorLike, p2: VectorLike, color: Color = Color.cyan, width: int | float = 1):
        ...
        Args:
            ...
            width: The width of the line. Defaults to 1.
        """
        Vector.raise_vector_like(p1, "p1")
        Vector.raise_vector_like(p2, "p2")
    ...
    def poly(
        ...
        x_coords, y_coords = zip(
            *(Vector.raise_vector_like(coord, "points") is None and (int(coord[0]), int(coord[1])) for coord in points)
        )
    ...
    def text(
        ...
        """
        Vector.raise_vector_like(pos, "pos")
        Vector.raise_vector_like(align, "align")
